...
public class Player {
	...
	public Player(String Nickname,int Experience,int Health,int Luck,int Evasion,int Survive,int CriticalRate,int CriticalDamage,int Damage,int Level,int Luckness,int Strength,int Vitality,int Dexterity,int AvailableStatsPoint) {
